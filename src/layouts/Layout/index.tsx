                    ...
                    <div className="d-xl-flex">
                        ...
                        {close ? (
                            ...
                            <>
                                ...
                                "/listing-tasks" ? (
                                    <div className="left_bar d-none d-xl-block">
                        ...
                        <div className="px-0 flex-grow-1 ">
                            ...
                            {window.location.pathname === "/listing-tasks" ? (
                                <div className="text-end float-button bothSideToggle  d-none d-xl-block">
                                    <button
                        ...
                        {close ? (
                            ...
                            <div
                                className={`position-relative px-0   sidePanelMain ${styles["sticky-right-pannel"]}`}
                                style={{
                                    minWidth: "300px",
                                }}
                            >
