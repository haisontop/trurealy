...
const Navigation = () => {
    ...
    return (
        <>
            ...
            >
                <Container className="d-md-flex justify-content-between py-1">
            ...
            <div
                className={`d-none d-lg-flex  py-2 align-items-center navigeationtwo ${
                    role === "agent" ? "" : "bg-primary"
                }`}
            >
            ...
            {/*============ responsive navbar ==========*/}
            <div
                className={`d-lg-none d-sm-flex py-3 navigeationtwo ${
                    role === "agent" ? "" : "bg-primary"
                }`}
            >
