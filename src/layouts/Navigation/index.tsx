...
const Navigation = () => {
    ...
    return (
        <div className="mainindex">
            ...
            >
                <Container className="d-md-flex justify-content-between my-3  ">
                    ...
                    <div className="d-flex align-items-center">
                        ...
                        <div className="d-flex gap-3 align-items-center">
                            <Link to="/">
                                ...
                                >
                                    <DotsCircleSvg width="27px" height="27px" />
                                </div>
                            </Link>
                            <Link to="/">
                                <div
                                ...
                                >
                                    <PositionSvg width="27px" height="27px" />
                                </div>
                            </Link>
                            <Link to="/">
                                <div
                ...
                <Container className="d-flex justify-content-center mx-10  ">
                    <div className="d-flex">
                        {(role === "agent"
                            ...
                            if (nav.secondary && nav.secondary.length > 0) {
                                return (
                                    <div
                                        className="text-decoration-none my-auto"
                                        onMouseEnter={() =>
                                            setSecondaryNavs(nav.secondary)
                                        }
                                    >
                                        <div
