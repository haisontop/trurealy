...
const Aboutcodefference = () => {
    ...
    return (
        <div className='ab-co-differrence position-relative'>
            ...
            <div className="about-defference-box mt-5">
          <div className="bg-primary about-defference-child-box text-white p-4">
...
export default Aboutcodefference;
