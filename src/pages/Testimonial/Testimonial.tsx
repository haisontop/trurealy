...
const TestimonialConsumer = ({ bgTheme }: TestimonialProps) => {
    ...
    return (
        <Layout>
            <div
                className={`container mx-auto px-0 pt-2 ${containerBg}`}
            >
                <TestimonialBanner />
                ...
                >
                    <h1 className="fw-normal" style={{ fontSize: "75px" }}>
                        PARTNER WITH SMARTER AGENTS
                    </h1>
                    <button className="bg-pink text-white px-5 py-2 fs-4 border-0 rounded rounded-4 mt-5">
                        Find An Agent
                    </button>
                </div>
            </div>
