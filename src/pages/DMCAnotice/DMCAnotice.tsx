    ...
    return (
        <Layout>
            <section className='DMCAnoticePageWrap'>
                ...
                <p>
                    We respect the intellectual property rights of others. Anyone who believes their work has been reproduced in a way that constitutes copyright infringement may notify our offices by providing the following information:
                </p>
                <ul>
                    <li>a) Identification of the copyrighted work that you claim has been infringed, or, if multiple copyrighted works at a single online site are covered by a single notification, a representative list of such works at the site;</li>
                    <li>
                ...
                <p>
                    If a notice of copyright infringement has been wrongly filed against you, you may submit a counter notification to our agent.
                </p>
                <p>
                    A valid counter notification is a written communication that incorporates the following elements:
                </p>
                <ul>
                    <li>a) A physical or electronic signature of the poster; </li>
                    <li>
                ...
                <p>
                    7373 N Scottsdale Dr A100
                </p>
                <p>
                    Scottsdale, AZ 85253, US
                </p>
                <p>
                    Attention: DMCA Designated Agent – DMCA Team
                </p>
                <p>
