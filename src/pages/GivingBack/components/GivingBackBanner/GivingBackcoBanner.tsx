...
function GivingBackcoBanner() {
  return (
    ...
    <div className='position-relative'>
          ...
          <div className={`d-flex text-white position-absolute top-0 left-0 ${styles["giving-banner-1"]} px-5 py-3`}>
              <h1 className='my-auto fw-bold me-1' style={{fontSize: "60px"}}>#TRUCARES</h1>
              <div>
                <img src="/assets/Love.png" width="80%" alt="" />
              </div>
          </div>
          <div className={`text-white position-absolute bottom-0 end-0 ${styles["giving-banner-2"]} px-5 py-3`}>
