            ...
            <div className="row align-items-center p-5">
                <div className="col-12 col-md-6 position-relative px-0">
                    <div
                        ...
                        style={{
                            backgroundImage:
                                "linear-gradient(48deg, #3B46F2 0%, #FD084F 100%)",
                            top: -30,
                            left: -30,
                            borderRadius: "1.5rem",
                            zIndex: -1,
                ...
                <div className="col-12 col-md-6 px-0">
                    <p
                        className="text-end fw-bolder text-uppercase mb-0 pe-3 display-1 text-primary"
                    >
                        Giving Back
                    </p>
                    <div
                        className="p-5 text-white h4"
                        style={{
                            backgroundColor: "#292670",
