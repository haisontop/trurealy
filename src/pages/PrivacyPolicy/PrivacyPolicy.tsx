            ...
            <section className="PrivacyPolicyWrap">
                ...
                <ul>
                    ...
                    <li>
                        ...
                        Consumer Privacy Act), refers to the Company as the
                        legal entity that collects Consumers’ personal
                    ...
                    <li>
                        ...
                        “We”, “Us” or “Our” in this Agreement) refers to Tru
                        Realty, 7373 north scottsdale road suite a100,
                        Scottsdale, AZ, 95255. For the purpose of the GDPR, the
                    ...
                    <li>
                        ...
                        every individual who is domiciled in the USA who is
                    ...
                    <li>
                        <b>Data Controller,</b> for the purposes of the GDPR
                    ...
                    <li>
                        <b>Facebook Fan Page</b> is a public profile named Tru
                        Realty specifically created by the Company on the
                ...
                <ul>
                    <li>
                        ...
                        Consumer Privacy Act), means selling, renting,
                        ...
                        personal information to another business or a third
                    ...
                    <li>
                        <b>Website</b> refers to Tru Realty, accessible from
                        www.trurealty.com
                    </li>
                    <li>
                ...
                <ul>
                    <li>
                        <b>Cookies or Browser Cookies</b>. A cookie is a small
                    ...
                    <li>
                        <b>Flash Cookies</b>. Certain features of our Service
                        may use local stored objects (or Flash Cookies) to
                    ...
                    <li>
                        <b>Web Beacons</b>. Certain sections of our Service and
                        our emails may contain small electronic files known as
                ...
                <ul>
                    <li>
                        <b>Necessary / Essential Cookies</b> <br /> Type:
                        Session Cookies <br /> Administered by: Us <br /> <br />
                    </li>
                    <li>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        information to develop and display content and
                        advertising (and work with third-party vendors who do
                ...
                <ul>
                    <li>
                        ...
                        and analyze the use of our Service, to show
                    ...
                    <li>
                        <b>For business transfers:</b> We may share or transfer
                    ...
                    <li>
                        <b>With Affiliates:</b> We may share Your information
                ...
                <ul>
                    <li>
                        ...
                        Google Analytics about visits activity. <br /> <br />
                    ...
                    <li>
                        <b>Clicky</b> <br /> <br />
                        Clicky is a web analytics service. Read the Privacy
                        Policy for Clicky here:{" "}
                    ...
                    <li>
                        ...
                        Flurry Analytics from using and sharing your information
                        by visiting the Flurry's Opt-out page:{" "}
                        ...
                        policies of Yahoo!, please visit their Privacy Policy
                        page:{" "}
                        <a href="https://policies.yahoo.com/xa/en/yahoo/privacy/index.html">
                    ...
                    <li>
                        ...
                        <br /> <br />
                        For more information on what type of information
                        Mixpanel collects, please visit the Terms of Use page of
                        Mixpanel:{" "}
                    ...
                    <li>
                        ...
                        improve Unity Technologies services, including
                        personalized advertising services. For more information
                        on what type of information Unity Technologies collects,
                        please visit their Privacy Policy page:{" "}
                        <a href="https://unity3d.com/legal/privacy-policy">
                            https://unity3d.com/legal/privacy-policy.
                        </a>{" "}
                        <br /> <br />
                        You can prevent Unity Analytics from using your
                        information by opting-out. To opt-out of Unity
                ...
                <ul>
                    <li>
                        ...
                        websites on the Internet. <br /> <br />
                    ...
                    <li>
                        <b>Bing Ads</b> <br /> <br />
                        Bing Ads is an advertising service provided by Microsoft
                        Inc. <br /> <br />
                    ...
                    <li>
                        ...
                        http://www.aboutads.info/choices/ or opt-out using your
                        mobile device settings. <br /> <br />
                        For more information AdColony, please visit the Privacy
                        Policy of AdColony:{" "}
                ...
                <ul className="">
                    <li>
                        ...
                        by The Rocket Science Group LLC. For more information on
                        the privacy practices of Mailchimp, please visit their
                        Privacy policy:{" "}
                    ...
                    <li>
                        ...
                        AWeber Communications. For more information on the
                        privacy practices of AWeber, please visit their Privacy
                        policy:
                    ...
                    <li>
                        ...
                        GetResponse is an email marketing sending service
                        provided by GetResponse. For more information on the
                        privacy practices of GetResponse, please visit their
                        Privacy policy:
                    ...
                    <li>
                        ...
                        <a href="https://getbrokerkit.com/home/privacy-policy/">
                ...
                <p>
                    Your browser may not permit You to block such technologies.
                ...
                <p>
                    ...
                    available) or other online identifiers collected on Our
                ...
                <ul>
                    <li>
                        ...
                        Analytics. For more information on the privacy practices
                    ...
                    <li>
                        ...
                        enabling the "Do Not Track" functionality of your web
                        browser or by following Pinterest instructions:{" "}
                        ...
                        <br /> <br />
                        You can learn more about the privacy practices and
                        policies of Pinterest by visiting their Privacy Po licy
                        page:{" "}
                    ...
                    <li>
                        ...
                        <a href="https://help.adroll.com/hc/en-us/articles/216599538-Opting-Out-of-Personalized-Advertising">
                        ...
                        "Information For California Residents Only" section in
                        the Privacy Policy of NextRoll, Inc.:{" "}
                ...
                <ul>
                    <li>
                        ...
                        reCAPTCHA is operated by Google. <br /> <br />
                        The reCAPTCHA service may collect information from You
                        and from Your Device for security purposes. <br />{" "}
                        <br />
                    ...
                    <li>
                        ...
                        shows how visitors click, move, scroll, browse, and pay
                    ...
                    <li>
                        ...
                        operated by Freshworks, Inc. <br /> <br />
                ...
                <ul>
                    <li>
                        <b>Consent:</b> You have given Your consent for
                        processing Personal Data for one or more specific
                        purposes.
                    </li>
                    <li>
                        <b>Performance of a contract:</b> Provision of Personal
                        Data is necessary for the performance of an agreement
                        with You and/or for any pre-contractual obligations
                        thereof.
                    </li>
                    <li>
                    ...
                    <li>
                        <b>Public interests:</b> Processing Personal Data is
                ...
                <ul>
                    <li>
                        <b>Request access to Your Personal Data.</b> The right
                    ...
                    <li>
                        <b>Request erasure of Your Personal Data.</b> You have
                        the right to ask Us to delete or remove Personal Data
                        when there is no good reason for Us to continue
                        processing it.
                    </li>
                    <li>
                        <b>Request the transfer of Your Personal Data.</b> We
                    ...
                    <li>
                        <b>Withdraw Your consent.</b> You have the right to
                        withdraw Your consent on using your Personal Data. If
                        You withdraw Your consent, We may not be able to provide
                        You with access to certain specific functionalities of
                        the Service.
                    </li>
                </ul>
                ...
                <p>
                    ...
                    Facebook Fan Page https://www.facebook.com/trurealty/, the
                    Company and the operator of the social network Facebook are
                    Joint Controllers. The Company has entered into agreements
                    with Facebook that define the terms for use of the Facebook
                    Fan Page, among other things. These terms are mostly based
                    on the Facebook Terms of Service:
                    https://www.facebook.com/terms.php Visit the Facebook
                    Privacy Policy https://www.facebook.com/policy.php for more
                    information about how Facebook manages Personal data or
                ...
                <ul>
                    <li>
                        <b>Directly from You.</b> For example, from the forms
                        You complete on our Service, preferences You express or
                        provide through our Service, or from Your purchases on
                        our Service.
                    </li>
                    <li>
                ...
                <ul>
                    <li>
                        ...
                        and the purposes for which the Personal Data is being
                        used.
                    </li>
                    <li>
                        The right to request. Under CCPA, You have the right to
                        request that We disclose information to You about Our
                        collection, use, sale, disclosure for business purposes
                        and share of personal information. Once We receive and
                        ...
                        <ol>
                            ...
                            <li>
                                ...
                                (opt-out). You have the right to direct Us to
                                not sell Your personal information. To submit an
                    ...
                    <li>
                        Comply with a legal obligation. •Make other internal and
                        lawful uses of that information that are compatible with
                ...
                <ul>
                    ...
                    <li>
                        By mail: 7373 north scottsdale road suite a100,
                        Scottsdale, AZ, 85258
                    </li>
                    <li>
                        ...
                        personal information. Your request to Us must:
                    </li>
                    <li>
                ...
                <p>
                    ...
                    please contact Us. The Service Providers we partner with
                    (for example, our analytics or advertising partners) may use
                    technology on the Service that sells personal information as
                    defined by the CCPA law. If you wish to opt out of the use
                    of Your personal information for interest-based advertising
                    purposes and these potential sales as defined under CCPA
                ...
                <p>
                    ...
                    Business and Professions Code section 22581 allow California
                    residents under the age of 18 who are registered users of
                    online sites, services or applications to request and obtain
                    ...
                    require removal in certain circumstances. LINKS TO OTHER
                    WEBSITES Our Service may contain links to other websites
                    ...
                    practices of any third party sites or services. CHANGES TO
                    THIS PRIVACY POLICY We may update Our Privacy Policy from
                    time to time. We will notify You of any changes by posting
                    the new Privacy Policy on this page. We will let You know
                    via email and/or a prominent notice on Our Service, prior to
                    the change becoming effective and update the "Last updated"
                ...
                <ul>
                    <li>
                        By email:{" "}
                        <a href="mailto:privacy@trurealty.com">
                            privacy@trurealty.com
                        </a>
                    </li>
                    <li>
                        By mail: 7373 north scottsdale road suite a100,
