        ...
        <Col>
            <Row>
                <Col sm={12} className="p-0">
                    <section className="pd-60-85 text-left whitedesc">
                        <Row>
                            <Col sm={12}>
                                ...
                                <h3 className="sub-title mb-40 mt-40">
                                    INTERPRETATION AND DEFINITIONS
                                </h3>
                                <h3 className="sub-title sub mb-40">
                                    INTERPRETATION
                                </h3>
                                <p>
                                ...
                                <h3 className="sub-title sub mt-40 mb-40">
                                    DEFINITIONS
                                </h3>
                                ...
                                <ul className="desc-list">
                                    <li>
                                        <b>Account</b> means a unique account
                                        created for You to access our Service or
                                        parts of our Service.
                                    </li>
                                    <li>
                                        <b>Business,</b> for the purpose of the
                                        CCPA (California Consumer Privacy Act),
                                        refers to the Company as the legal
                                        entity that collects Consumers’ personal
                                        information and determines the purposes
                                        and means of the processing of
                                        Consumers’ personal information, or on
                                        behalf of which such information is
                                        collected and that alone, or jointly
                                        with others, determines the purposes and
                                        means of the processing of consumers’
                                        personal information, that does business
                                        in the State of California.{" "}
                                    </li>
                                    <li>
                                        <b>Company</b> (referred to as either
                                        “the Company”, “We”, “Us” or “Our” in
                                        this Agreement) refers to Tru Realty,
                                        7373 north scottsdale road suite a100,
                                        Scottsdale, AZ, 95255.<br></br> For the
                                        purpose of the GDPR, the Company is the
                                        Data Controller.
                                    </li>
                                    <li>
                                        <b>Consumer,</b> for the purpose of the
                                        CCPA (California Consumer Privacy Act),
                                        means a natural person who is a
                                        California resident. A resident, as
                                        defined in the law, includes (1) every
                                        individual who is in the USA for other
                                        than a temporary or transitory purpose,
                                        and (2) every individual who is
                                        domiciled in the USA who is outside the
                                        USA for a temporary or transitory
                                        purpose.
                                    </li>
                                    <li>
                                        <b>Cookies</b> are small files that are
                                        placed on Your computer, mobile device
                                        or any other device by a website,
                                        containing the details of Your browsing
                                        history on that website among its many
                                        uses.
                                    </li>
                                    <li>
                                        <b>Country</b> refers to: Arizona,
                                        United States
                                    </li>
                                    <li>
                                        <b>Data Controller,</b> for the purposes
                                        of the GDPR (General Data Protection
                                        Regulation), refers to the Company as
                                        the legal person which alone or jointly
                                        with others determines the purposes and
                                        means of the processing of Personal
                                        Data.
                                    </li>
                                    <li>
                                        <b>Device</b>  means any device that can
                                        access the Service such as a computer, a
                                        cellphone or a digital tablet.{" "}
                                    </li>
                                    <li>
                                        <b>Do Not Track</b> (DNT) is a concept
                                        that has been promoted by US regulatory
                                        authorities, in particular the U.S.
                                        Federal Trade Commission (FTC), for the
                                        Internet industry to develop and
                                        implement a mechanism for allowing
                                        internet users to control the tracking
                                        of their online activities across
                                        websites.
                                    </li>
                                    <li>
                                        <b>Facebook Fan Page</b> is a public
                                        profile named Tru Realty specifically
                                        created by the Company on the Facebook
                                        social network, accessible
                                        from https://www.facebook.com/trurealty/
                                    </li>
                                    <li>
                                        <b>Personal Data</b> is any information
                                        that relates to an identified or
                                        identifiable individual.
                                        <br /> For the purposes for GDPR,
                                        Personal Data means any information
                                        relating to You such as a name, an
                                        ...
                                        <span className="newtext">
                                            ...
                                            describes or is capable of being
                                    ...
                                    <li>
                                        <b>Sale,</b> for the purpose of the CCPA
                                        (California Consumer Privacy Act), means
                                        ...
                                        information to another business or a
                                        third party for monetary or other
                                        valuable consideration.
                                    </li>
                                    <li>
                                        <b>Service refers to the Website.</b>
                                    </li>
                                    <li>
                                        <b>Service Provider</b> means any
                                        ...
                                        or to assist the Company in analyzing
                                        how the Service is used. For the purpose
                                        of the GDPR, Service Providers are
                                    ...
                                    <li>
                                        <b>Website</b> refers to Tru Realty,
                                        accessible from www.trurealty.com
                                    </li>
                                    <li>
                                        <b>You</b> means the individual
                                        ...
                                        <span className="newtext">
                                            ...
                                            Regulation), You can be referred to
                                            as the Data Subject or as the User
                                            as you are the individual using the
                                            Service.
                                        </span>
                                    </li>
                                </ul>
                                ...
                                <ul className="desc-list">
                                    ...
                                    <li>
                                        Bank account information in order to pay
                                        for products and/or services within the
                                        Service
                                    </li>
                                    <li>Usage Data</li>
                                </ul>
                                <p>
                                    When You pay for a product and/or a service
                                    via bank transfer, We may ask You to provide
                                    information to facilitate this transaction
                                    and to verify Your identity. Such
                                ...
                                <ul className="desc-list">
                                    ...
                                    <li>
                                        Other information linking You to an
                                        address
                                    </li>
                                </ul>
                                <h3 className="sub-title mb-40 mt-40">
                                ...
                                <ul className="desc-list">
                                    <li>
                                        <b>Cookies or Browser Cookies.</b> A
                                        cookie is a small file placed on Your
                                    ...
                                    <li>
                                        <b>Flash Cookies.</b> Certain features
                                        of our Service may use local stored
                                        objects (or Flash Cookies) to collect
                                        and store information about Your
                                        preferences or Your activity on our
                                        Service. Flash Cookies are not managed
                                        by the same browser settings as those
                                        used for Browser Cookies. For more
                                        information on how You can delete Flash
                                        Cookies, please read “Where can I change
                                        the settings for disabling, or deleting
                                        local shared objects?” available
                                    ...
                                    <li>
                                        ...
                                        our Service and our emails may contain
                                        small electronic files known as web
                                        beacons (also referred to as clear gifs,
                                        pixel tags, and single-pixel gifs) that
                                        permit the Company, for example, to
                                        count users who have visited those pages
                                        or opened an email and for other related
                                        website statistics (for example,
                                        recording the popularity of a certain
                                ...
                                <p>
                                    ...
                                    here: All About Cookies by TermsFeed.
                                </p>
                                <p>
                                ...
                                <ul className="desc-list">
                                    ...
                                    <li>
                                        ...
                                        <span className="newtext">
                                            ...
                                            browsing habits to enable Us to show
                                            advertising which is more likely to
                                            be of interest to You. These Cookies
                                            use information about your browsing
                                            history to group You with other
                                            users who have similar interests.
                                            Based on that information, and with
                                            Our permission, third party
                                            advertisers can place Cookies to
                                            enable them to show adverts which We
                                            think will be relevant to your
                                            interests while You are on third
                                            party websites.
                                        </span>
                                    </li>
                                </ul>
                                ...
                                <ul className="desc-list">
                                    ...
                                    <li>
                                        ...
                                        The Personal Data You provide can give
                                        You access to different functionalities
                                        of the Service that are available to You
                                        as a registered user.
                                    </li>
                                    <li>
                                        For the performance of a contract: the
                                        development, compliance and undertaking
                                        of the purchase contract for the
                                    ...
                                    <li>
                                        ...
                                        and general information about other
                                        goods, services and events which we
                                        offer that are similar to those that you
                                        have already purchased or enquired about
                                        unless You have opted not to receive
                                        such information.
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        ...
                                        work with third-party vendors who do so)
                                    ...
                                    <li>
                                        ...
                                        sale or transfer of some or all of Our
                                        assets, whether as a going concern or as
                                        part of bankruptcy, liquidation, or
                                        similar proceeding, in which Personal
                                        Data held by Us about our Service users
                                    ...
                                    <li>
                                        ...
                                        and improve our Service, products,
                                ...
                                <ul className="desc-list">
                                    <li>
                                        <b>With Service Providers:</b> We may
                                        share Your personal information with
                                        Service Providers to monitor and analyze
                                        the use of our Service, to show
                                        advertisements to You to help support
                                        and maintain Our Service, to advertise
                                        on third party websites to You after You
                                        visited our Service, for payment
                                        processing, to contact You.
                                    </li>
                                    <li>
                                        <b>For business transfers:</b> We may
                                        share or transfer Your personal
                                ...
                                <h3 className="sub-title sub mt-40">
                                ...
                                <p>
                                    ...
                                    to Your Personal Data. These third-party
                                    vendors collect, store, use, process and
                                    transfer information about Your activity on
                                    Our Service in accordance with their Privacy
                                    Policies.
                                </p>
                                <h3 className="sub-title sub mt-40">
                                    ANALYTICS
                                ...
                                <ul className="desc-list">
                                    <li>
                                        ...
                                        <span className="newtext">
                                            ...
                                            Google Analytics JavaScript (ga.js,
                                    ...
                                    <li>
                                        ...
                                        <span className="newtext">
                                            ...
                                            Google's policy for safeguarding
                                            your data: 
                                            <a
                                    ...
                                    <li>
                                        ...
                                        <span className="newtext">
                                            ...
                                            You can visit their Privacy Policy
                                            page here:{" "}
                                            <a
                                    ...
                                    <li>
                                        ...
                                        <span className="newtext">
                                            ...
                                            Read the Privacy Policy for Clicky
                                            here: 
                                            <a
                                    ...
                                    <li>
                                        <b>Statcounter</b>
                                        <span className="newtext">
                                            Statcounter is a web traffic
                                            analysis tool. You can read the
                                    ...
                                    <li>
                                        <b>Flurry Analytics</b>
                                        <span className="newtext">
                                            Flurry Analytics service is provided
                                            by Yahoo! Inc.
                                        </span>
                                        <span className="newtext">
                                            You can opt-out from Flurry
                                            Analytics service to prevent Flurry
                                            Analytics from using and sharing
                                            your information by visiting the
                                        ...
                                        <span className="newtext">
                                            For more information on the privacy
                                            practices and policies of Yahoo!,
                                            please visit their Privacy Policy
                                            page: 
                                            <a
                                                href="https://policies.yahoo.com/xa/en/yahoo/privacy/index.html"
                                                target="_blank"
                                                rel="noopener noreferrer"
                                            >
                                    ...
                                    <li>
                                        ...
                                        <span className="newtext">
                                            You can prevent Mixpanel from using
                                            your information for analytics
                                            purposes by opting-out. To opt-out
                                            of Mixpanel service, please visit
                                            this page: 
                                            <a
                                        ...
                                        <span className="newtext">
                                            For more information on what type of
                                            information Mixpanel collects,
                                            please visit the Terms of Use page
                                            of Mixpanel: 
                                            <a
                                    ...
                                    <li>
                                        <b>Unity Analytics</b>
                                        <span className="newtext">
                                            Unity Analytics is provided by Unity
                                            Technologies.
                                        </span>
                                        <span className="newtext">
                                            Unity Analytics collects, stores,
                                            uses, processes, and transfers
                                            personal information to provide,
                                            operate, and improve Unity
                                            Technologies services, including
                                            personalized advertising services.
                                            For more information on what type of
                                            information Unity Technologies
                                            collects, please visit their Privacy
                                            Policy page: 
                                            <a
                                        ...
                                        <span className="newtext">
                                            You can prevent Unity Analytics from
                                            using your information by
                                            opting-out. To opt-out of Unity
                                            Analytics, please visit this page: 
                                            <a
                                                href="https://unity3d.com/legal/privacy-policy"
                                                target="_blank"
                                                rel="noopener noreferrer"
                                        ...
                                        <span className="newtext">
                                            ...
                                            advertising by enabling privacy
                                            features on Your mobile device such
                                            as Limit Ad Tracking (iOS) and Opt
                                            Out of Ads Personalization
                                            (Android). See Your mobile device
                                ...
                                <ul className="desc-list">
                                    ...
                                    <li>
                                        ...
                                        <span className="newtext">
                                            You can opt-out from the AdMob by
                                            Google service by following the
                                    ...
                                    <li>
                                        <b>Bing Ads</b>
                                        <span className="newtext">
                                            Bing Ads is an advertising service
                                            provided by Microsoft Inc.
                                        </span>

                                        <span className="newtext">
                                            You can opt-out from Bing Ads by
                                            following the instructions on Bing
                                            Ads Opt-out page: 
                                            <a
                                        ...
                                        <span className="newtext">
                                            For more information about Bing Ads,
                                            please visit their Privacy Policy: 
                                            <a
                                    ...
                                    <li>
                                        ...
                                        <span className="newtext">
                                            You can opt-out from AdColony
                                            service by visiting the AdColony
                                            Opt-out page: 
                                            <a
                                        ...
                                        <span className="newtext">
                                            You can also opt-out from AdColony
                                            ...
                                            or opt-out using your mobile device
                                            settings.
                                        </span>
                                        <span className="newtext">
                                            For more information AdColony,
                                            please visit the Privacy Policy of
                                            AdColony: 
                                            <a
                                ...
                                <p>
                                    ...
                                    of interest to You. You may opt-out of
                                    receiving any, or all, of these
                                    communications from Us by following the
                                    unsubscribe link or instructions provided in
                                    any email We send or by contacting Us.
                                </p>
                                <p>
                                    We may use Email Marketing Service Providers
                                    to manage and send emails to You.
                                </p>
                                <ul className="desc-list">
                                    <li>
                                        <b>Mailchimp</b>
                                        <span className="newtext">
                                            Mailchimp is an email marketing
                                            sending service provided by The
                                            Rocket Science Group LLC.
                                        </span>

                                        <span className="newtext">
                                            For more information on the privacy
                                            practices of Mailchimp, please visit
                                    ...
                                    <li>
                                        <b>AWeber</b>
                                        <span className="newtext">
                                            AWeber is an email marketing sending
                                            service provided by AWeber
                                            Communications.
                                        </span>

                                        <span className="newtext">
                                            For more information on the privacy
                                            practices of AWeber, please visit
                                            their Privacy policy: 
                                            <a
                                    ...
                                    <li>
                                        <b>GetResponse</b>
                                        <span className="newtext">
                                            GetResponse is an email marketing
                                            sending service provided by
                                            GetResponse.
                                        </span>

                                        <span className="newtext">
                                            For more information on the privacy
                                            practices of GetResponse, please
                                    ...
                                    <li>
                                        ...
                                        <span className="newtext">
                                            ...
                                            at 
                                            <a
                                                href="https://getbrokerkit.com/home/privacy-policy/"
                                                target="_blank"
                                                rel="noopener noreferrer"
                                            >
                                                https://getbrokerkit.com/home/privacy-policy/
                                            </a>
                                        </span>
                                    </li>
                                </ul>
                                ...
                                <p>
                                    ...
                                    card details. That information is provided
                                    directly to Our third-party payment
                                    processors whose use of Your personal
                                    information is governed by their Privacy
                                    Policy. These payment processors adhere to
                                    the standards set by PCI-DSS as managed by
                                    the PCI Security Standards Council, which is
                                    a joint effort of brands like Visa,
                                ...
                                <p>
                                    {" "}
                                    When You use Our Service to pay a product
                                    and/or service via bank transfer, We may ask
                                    You to provide information to facilitate
                                    this transaction and to verify Your
                                    identity.
                                </p>
                                <h3 className="sub-title mb-40 mt-40">
                                ...
                                <p>
                                    ...
                                    advertise to You after You accessed or
                                    visited our Service. We and Our third-party
                                    vendors use cookies and non-cookie
                                    technologies to help Us recognize Your
                                    Device and understand how You use our
                                    Service so that We can improve our Service
                                    to reflect Your interests and serve You
                                    advertisements that are likely to be of more
                                    interest to You.
                                </p>
                                <p>
                                    These third-party vendors collect, store,
                                    use, process and transfer information about
                                    Your activity on Our Service in accordance
                                    with their Privacy Policies and to enable Us
                                    to:
                                </p>
                                <ul className="desc-list">
                                    <li>
                                        Measure and analyze traffic and browsing
                                        activity on Our Service
                                    </li>
                                    <li>
                                        Show advertisements for our products
                                        and/or services to You on third-party
                                        websites or apps
                                    </li>
                                    <li>
                                ...
                                <p>
                                    ...
                                    non-cookie technologies that may not be
                                    impacted by browser settings that block
                                    cookies.
                                </p>
                                <p>
                                    Your browser may not permit You to block
                                    such technologies. You can use the following
                                    third-party tools to decline the collection
                                ...
                                <p>
                                    You may opt-out of all personalized
                                    advertising by enabling privacy features on
                                    Your mobile device such as Limit Ad Tracking
                                    (iOS) and Opt Out of Ads Personalization
                                    (Android). See Your mobile device Help
                                    system for more information.
                                </p>
                                <p>
                                    We may share information, such as hashed
                                    email addresses (if available) or other
                                    online identifiers collected on Our Service
                                    with these third-party vendors. This allows
                                    Our third-party vendors to recognize and
                                    deliver You ads across devices and browsers.
                                    To read more about the technologies used by
                                    these third-party vendors and their
                                    cross-device capabilities please refer to
                                    the Privacy Policy of each vendor listed
                                    below.
                                </p>
                                ...
                                <ul className="desc-list">
                                    <li>
                                        ...
                                        <span className="newtext">
                                            ...
                                            for Display Advertising and
                                            customise the Google Display Network
                                            ads by visiting the Google Ads
                                            Settings page: 
                                            <a
                                        ...
                                        <span className="newtext">
                                            Google Analytics Opt-out Browser
                                            Add-on provides visitors with the
                                            ability to prevent their data from
                                            being collected and used by Google
                                            Analytics.
                                        </span>
                                        <span className="newtext">
                                            For more information on the privacy
                                    ...
                                    <li>
                                        ...
                                        <span className="newtext">
                                            Bing Ads remarketing service is
                                            provided by Microsoft Inc.
                                        </span>

                                        <span className="newtext">
                                            You can opt-out of Bing Ads
                                            interest-based ads by following
                                            their instructions:
                                            <a
                                                href="https://advertise.bingads.microsoft.com/en-us/resources/policies/personalized-ads"
                                                target="_blank"
                                        ...
                                        <span className="newtext">
                                            ...
                                            practices and policies of Microsoft
                                    ...
                                    <li>
                                        <b>Twitter</b>
                                        <span className="newtext">
                                            Twitter remarketing service is
                                        ...
                                        <span className="newtext">
                                            You can learn more about the privacy
                                            practices and policies of Twitter by
                                    ...
                                    <li>
                                        ...
                                        <span className="newtext">
                                            ...
                                            interest-based advertising from
                                        ...
                                        <span className="newtext">
                                            ...
                                            interest-based ads, follow these
                                            instructions from Facebook: page:
                                            <a
                                        ...
                                        <span className="newtext">
                                            ...
                                            Advertising Alliance. You can also
                                            opt-out from Facebook and other
                                            participating companies through the
                                            Digital Advertising Alliance in the
                                            USA 
                                            <a
                                                href="http://www.aboutads.info/choices/"
                                                target="_blank"
                                            ...
                                            or the European Interactive Digital
                                            ...
                                            , or opt-out using your mobile
                                            device settings
                                        </span>
                                        <span className="newtext">
                                            For more information on the privacy
                                            practices of Facebook, please visit
                                    ...
                                    <li>
                                        <b>Pinterest</b>
                                        <span className="newtext">
                                            Pinterest remarketing service is
                                            provided by Pinterest Inc.
                                        </span>
                                        <span className="newtext">
                                            You can opt-out from Pinterest's
                                            interest-based ads by enabling the
                                            "Do Not Track" functionality of your
                                            web browser or by following
                                        ...
                                        <span className="newtext">
                                            You can learn more about the privacy
                                            practices and policies of Pinterest
                                            by visiting their Privacy Po licy
                                            page:
                                            <a
                                    ...
                                    <li>
                                        <b>AdRoll</b>
                                        <span className="newtext">
                                            AdRoll remarketing service is
                                            provided by NextRoll, Inc.
                                        </span>
                                        <span className="newtext">
                                            You can opt-out of AdRoll
                                            remarketing by visiting this AdRoll
                                            ...
                                             or the Opt Out of Personalized
                                        ...
                                        <span className="newtext">
                                            ...
                                            California Residents Only" section
                                            in the Privacy Policy of NextRoll,
                                            Inc.: 
                                            <a
                                        ...
                                        <span className="newtext">
                                            For more information on the privacy
                                            practices of AdRoll, please visit
                                            the NextRoll, Inc. Privacy Policy
                                            web page: 
                                            <a
                                ...
                                <p>
                                    We may use third-party Service Providers to
                                    provide better improvement of our Service.
                                </p>
                                <ul className="desc-list">
                                    <li>
                                        <b>Invisible reCAPTCHA</b>
                                        <span className="newtext">
                                            We use an invisible captcha service
                                            named reCAPTCHA. reCAPTCHA is
                                            operated by Google.
                                        </span>
                                        <span className="newtext">
                                            The reCAPTCHA service may collect
                                            information from You and from Your
                                            Device for security purposes.
                                        </span>

                                        <span className="newtext">
                                            The information gathered by
                                            reCAPTCHA is held in accordance with
                                    ...
                                    <li>
                                        <b>Mouseflow</b>
                                        <span className="newtext">
                                            Mouseflow is a session replay and
                                            heatmap tool that shows how visitors
                                            click, move, scroll, browse, and pay
                                            attention on websites. The service
                                            is operated by ApS.
                                        </span>
                                        <span className="newtext">
                                            Mouseflow service may collect
                                            information from Your device.
                                        </span>

                                        <span className="newtext">
                                            The information gathered by
                                            Mouseflow is held in accordance with
                                            its Privacy Policy: 
                                            <a
                                    ...
                                    <li>
                                        ...
                                        <span className="newtext">
                                            ...
                                            software. The service is operated by
                                            Freshworks, Inc.
                                        </span>
                                        <span className="newtext">
                                            FreshDesk service may collect
                                            information from Your Device.
                                        </span>

                                        <span className="newtext">
                                            The information gathered by
                                            FreshDesk is held in accordance with
                                            its Privacy Policy: 
                                            <a
                                    ...
                                    <li>
                                        <b>Google Places</b>
                                        <span className="newtext">
                                            Google Places is a service that
                                            returns information about places
                                            using HTTP requests. It is operated
                                            by Google
                                        </span>
                                        <span className="newtext">
                                            Google Places service may collect
                                            information from You and from Your
                                            Device for security purposes.
                                        </span>

                                        <span className="newtext">
                                            The information gathered by Google
                                            Places is held in accordance with
                                            the Privacy Policy of Google: 
                                            <a
                                                href="https://www.google.com/intl/en/policies/privacy/"
                                                target="_blank"
                                ...
                                <ul className="desc-list">
                                    <li>
                                        <b>Consent:</b> You have given Your
                                    ...
                                    <li>
                                        ...
                                        for the performance of an agreement with
                                        You and/or for any pre-contractual
                                        obligations thereof.
                                    </li>
                                    <li>
                                        <b>Legal obligations:</b> Provision of
                                        Processing Personal Data is necessary
                                        for compliance with a legal obligation
                                        to which the Company is subject.
                                    </li>
                                    <li>
                                        <b>Vital interests:</b> Processing
                                        Personal Data is necessary in order to
                                        protect Your vital interests or of
                                        another natural person.
                                    </li>
                                    <li>
                                        <b>Public interests:</b> Processing
                                        Personal Data is related to a task that
                                        is carried out in the public interest or
                                        in the exercise of official authority
                                        vested in the Company.
                                    </li>
                                    <li>
                                        <b>Legitimate interests:</b> Processing
                                ...
                                <p>
                                    ...
                                    guarantee You can exercise Your rights. You
                                    have the right under this Privacy Policy,
                                ...
                                <ul className="desc-list">
                                    <li>
                                        ...
                                         The right to access, update or delete
                                        the information We have on You. Whenever
                                        made possible, you can access, update or
                                        request deletion of Your Personal Data
                                        directly within Your account settings
                                        section. If you are unable to perform
                                        these actions yourself, please contact
                                        Us to assist You. This also enables You
                                    ...
                                    <li>
                                        ...
                                        incomplete or inaccurate information We
                                    ...
                                    <li>
                                        ...
                                        This right exists where We are relying
                                        on a legitimate interest as the legal
                                        basis for Our processing and there is
                                        something about Your particular
                                        situation, which makes You want to
                                        object to our processing of Your
                                        Personal Data on this ground. You also
                                        have the right to object where We are
                                    ...
                                    <li>
                                        ...
                                        You have the right to ask Us to delete
                                        or remove Personal Data when there is no
                                    ...
                                    <li>
                                        ...
                                        We will provide to You, or to a
                                        third-party You have chosen, Your
                                        Personal Data in a structured, commonly
                                        used, machine-readable format. Please
                                        note that this right only applies to
                                        automated information which You
                                        initially provided consent for Us to use
                                        or where We used the information to
                                        perform a contract with You.
                                    </li>
                                    <li>
                                        <b>Withdraw Your consent. </b>
                                        You have the right to withdraw Your
                                        consent on using your Personal Data. If
                                        You withdraw Your consent, We may not be
                                        able to provide You with access to
                                ...
                                <p>
                                    ...
                                    by contacting Us. Please note that we may
                                    ask You to verify Your identity before
                                    responding to such requests. If You make a
                                    request, We will try our best to respond to
                                ...
                                <p>
                                    ...
                                    information, if You are in the European
                                    Economic Area (EEA), please contact Your
                                ...
                                <p>
                                    ...
                                    Personal Data collected while using the
                                    Service. As operator of the Facebook Fan
                                    Page {" "}
                                    <a
                                        href="https://www.facebook.com/trurealty/"
                                        target="_blank"
                                        rel="noopener noreferrer"
                                    >
                                        https://www.facebook.com/trurealty/
                                    </a>
                                    , the Company and the operator of the social
                                    network Facebook are Joint Controllers. The
                                    Company has entered into agreements with
                                    Facebook that define the terms for use of
                                    the Facebook Fan Page, among other things.
                                    These terms are mostly based on the Facebook
                                    Terms of
                                    ...
                                     for more information about how Facebook
                                    manages Personal data or contact Facebook
                                    online, or by mail: Facebook, Inc. ATTN,
                                ...
                                <p>
                                    ...
                                    Facebook Fan Page and on the basis of the
                                    GDPR, in order to obtain anonymized
                                    statistical data about Our users.
                                </p>
                                <p>
                                    For this purpose, Facebook places a Cookie
                                    on the device of the user visiting Our
                                    Facebook Fan Page. Each Cookie contains a
                                    unique identifier code and remains active
                                    for a period of two years, except when it is
                                    deleted before the end of this period.{" "}
                                </p>
                                <p>
                                    Facebook receives, records and processes the
                                    information stored in the Cookie, especially
                                    when the user visits the Facebook services,
                                    services that are provided by other members
                                    of the Facebook Fan Page and services by
                                    other companies that use Facebook services.
                                </p>
                                <p>
                                    For more information on the privacy
                                    practices of Facebook, please visit Facebook
                                    Privacy Policy here: 
                                    <a
                                        href="https://www.facebook.com/privacy/explanation"
                                        target="_blank"
                                ...
                                <p>
                                    ...
                                    residents supplements the information
                                    contained in Our Privacy Policy and it
                                    applies solely to all visitors, users, and
                                    others who reside in the State of
                                    California.
                                </p>
                                <h3 className="sub-title mb-40 mt-40">
                                ...
                                <p>
                                    ...
                                    relates to, describes, references, is
                                    capable of being associated with, or could
                                    reasonably be linked, directly or
                                    indirectly, with a particular Consumer or
                                    Device. The following is a list of
                                    categories of personal information which we
                                    may collect or may have been collected from
                                    California residents within the last twelve
                                    (12) months.
                                </p>
                                <p>
                                    Please note that the categories and examples
                                    provided in the list below are those defined
                                    in the CCPA. This does not mean that all
                                    examples of that category of personal
                                    information were in fact collected by Us,
                                    but reflects our good faith belief to the
                                    best of our knowledge that some of that
                                    information from the applicable category may
                                    be and may have been collected. For example,
                                    certain categories of personal information
                                    would only be collected if You provided such
                                    personal information directly to Us.
                                </p>
                                <ul className="desc-list no-list-style">
                                    <li>
                                        <b> Category A: Identifiers.</b>
                                        <span className="newtext">
                                            Examples: A real name, alias, postal
                                            address, unique personal identifier,
                                            online identifier, Internet Protocol
                                            address, email address, account
                                    ...
                                    <li>
                                        ...
                                        <span className="newtext">
                                            ...
                                            patterns used to extract a template
                                            or other identifier or identifying
                                            information, such as, fingerprints,
                                            faceprints, and voiceprints, iris or
                                            retina scans, keystroke, gait, or
                                            other physical patterns, and sleep,
                                    ...
                                    <li>
                                        ...
                                        <span className="newtext">
                                            ...
                                            related to a student maintained by
                                            an educational institution or party
                                    ...
                                    <li>
                                        <b>
                                            Category K: Inferences drawn from
                                ...
                                <ul className="desc-list">
                                    <li>
                                        <b>Directly from You.</b> For example,
                                        from the forms You complete on our
                                        Service, preferences You express or
                                        provide through our Service, or from
                                        Your purchases on our Service.
                                    </li>
                                    <li>
                                        <b>Indirectly from You.</b> For example,
                                        from observing Your activity on our
                                        Service.
                                    </li>
                                    <li>
                                        <b>Automatically from You.</b> For
                                        example, through cookies We or our
                                        Service Providers set on Your Device as
                                        You navigate through our Service.
                                    </li>
                                    <li>
                                        <b>From Service Providers.</b> For
                                        example, third-party vendors to monitor
                                        and analyze the use of our Service,
                                        third-party vendors to provide
                                        advertising on our Service, third-party
                                        vendors to deliver targeted advertising
                                        to You, third-party vendors for payment
                                        processing, or other third-party vendors
                                        that We use to provide the Service to
                                        You.
                                    </li>
                                </ul>
                                <h3 className="sub-title mb-40 mt-40">
                                ...
                                <p>
                                    ...
                                    We collect for "business purposes" or
                                    "commercial purposes" (as defined under the
                                    CCPA), which may include the following
                                    examples:
                                </p>
                                <ul className="desc-list">
                                    <li>
                                    ...
                                    <li>
                                        ...
                                        respond to Your inquiries, including to
                                        investigate and address Your concerns
                                        and monitor and improve our Service.
                                    </li>
                                    <li>
                                        To fulfill or meet the reason You
                                        provided the information. For example,
                                        if You share Your contact information to
                                        ask a question about our Service, We
                                        will use that personal information to
                                        respond to Your inquiry. If You provide
                                        Your personal information to purchase a
                                        product or service, We will use that
                                        information to process Your payment and
                                        facilitate delivery.
                                    </li>
                                    <li>
                                        To respond to law enforcement requests
                                        and as required by applicable law, court
                                    ...
                                    <li>
                                        To detect security incidents and protect
                                        against malicious, deceptive, fraudulent
                                        or illegal activity, including, when
                                ...
                                <p>
                                    ...
                                    exhaustive. For more details on how we use
                                    this information, please refer to the "Use
                                    of Your Personal Data" section.
                                </p>
                                <p>
                                    If We decide to collect additional
                                    categories of personal information or use
                                    the personal information We collected for
                                    materially different, unrelated, or
                                    incompatible purposes We will update this
                                    Privacy Policy.
                                </p>
                                <h3 className="sub-title mb-40 mt-40">
                                ...
                                <p>
                                    ...
                                    personal information were in fact disclosed,
                                    but reflects our good faith belief to the
                                    best of our knowledge that some of that
                                    information from the applicable category may
                                ...
                                <p>
                                    ...
                                    enter a contract that describes the purpose
                                    and requires the recipient to both keep that
                                    personal information confidential and not
                                    use it for any purpose except performing the
                                    contract.
                                </p>
                                <h3 className="sub-title mb-40 mt-40">
                                ...
                                <p>
                                    ...
                                    mean selling, renting, releasing,
                                    disclosing, disseminating, making available,
                                    transferring, or otherwise communicating
                                    orally, in writing, or by electronic or
                                    other means, a consumer's personal
                                    information by the business to a third party
                                    for valuable consideration. This means that
                                    We may have received some kind of benefit in
                                    return for sharing personal information, but
                                ...
                                <p>
                                    ...
                                    reflects our good faith belief to the best
                                    of our knowledge that some of that
                                    information from the applicable category may
                                    be and may have been shared for value in
                                    return.
                                </p>
                                <p>
                                    We may sell and may have sold in the last
                                    twelve (12) months the following categories
                                ...
                                <h3 className="sub-title mb-40 mt-40">
                                    SALE OF PERSONAL INFORMATION OF MINORS UNDER
                                    16 YEARS OF AGE
                                </h3>
                                <p>
                                    ...
                                    Consumer less than 13 years of age.
                                    Consumers who opt-in to the sale of personal
                                    information may opt-out of future sales at
                                    any time. To exercise the right to opt-out,
                                ...
                                <p>
                                    ...
                                    under the age of 13 (or 16) has provided Us
                                ...
                                <ul className="desc-list">
                                    <li>
                                        ...
                                        to be notified which categories of
                                        Personal Data are being collected and
                                    ...
                                    <li>
                                        ...
                                        disclose information to You about Our
                                        collection, use, sale, disclosure for
                                        ...
                                        <ul className="desc-list">
                                            ...
                                            <li>
                                                ...
                                                of Personal Data (opt-out). You
                                                have the right to direct Us to
                                                not sell Your personal
                                                information. To submit an
                                                opt-out request please contact
                                                Us.
                                            </li>
                                        </ul>
                                    </li>
                                    <li>
                                        ...
                                        have the right to request the deletion
                                        of Your Personal Data, subject to
                                        certain exceptions. Once We receive and
                                        confirm Your request, We will delete
                                        (and direct Our Service Providers to
                                        delete) Your personal information from
                                        our records, unless an exception
                                        applies. We may deny Your deletion
                                        request if retaining the information is
                                        necessary for Us or Our Service
                                        Providers to:
                                        <ul className="desc-list">
                                            <li>
                                                Complete the transaction for
                                                which We collected the personal
                                                information, provide a good or
                                                service that You requested, take
                                                actions reasonably anticipated
                                                within the context of our
                                                ongoing business relationship
                                                with You, or otherwise perform
                                            ...
                                            <li>
                                                Exercise free speech, ensure the
                                                right of another consumer to
                                                exercise their free speech
                                                rights, or exercise another
                                            ...
                                            <li>
                                                ...
                                                applicable ethics and privacy
                                                laws, when the information's
                                                deletion may likely render
                                                impossible or seriously impair
                                                the research's achievement, if
                                                You previously provided informed
                                                consent.
                                            </li>
                                            <li>
                                                Enable solely internal uses that
                                                are reasonably aligned with
                                                consumer expectations based on
                                    ...
                                    <li>
                                        ...
                                        discriminated against for exercising any
                                        ...
                                        <ul className="desc-list">
                                            ...
                                            <li>
                                                ...
                                                rates for goods or services,
                                                including the use of discounts
                                                or other benefits or imposing
                                                penalties
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                Suggesting that You will receive
                                                a different price or rate for
                                                goods or services or a different
                                ...
                                <p>
                                    ...
                                    under the CCPA, and if You are a California
                                    resident, You can contact Us:
                                </p>
                                <ul className="desc-list">
                                    <li>By email: privacy@trurealty.com </li>
                                    <li>
                                        By mail: 7373 north scottsdale road
                                        suite a100, Scottsdale, AZ, 85258
                                    </li>
                                </ul>
                                <p>
                                    Only You, or a person registered with the
                                    California Secretary of State that You
                                    authorize to act on Your behalf, may make a
                                    verifiable request related to Your personal
                                    information.{" "}
                                </p>
                                ...
                                <p>
                                    ...
                                    days when reasonable necessary and with
                                    prior notice.
                                </p>
                                <p>
                                    Any disclosures We provide will only cover
                                    the 12-month period preceding the verifiable
                                    request's receipt.
                                </p>
                                <p>
                                    {" "}
                                    For data portability requests, We will
                                    select a format to provide Your personal
                                    information that is readily useable and
                                ...
                                <p>
                                    ...
                                    Your personal information. Once We receive
                                    and confirm a verifiable consumer request
                                    from You, we will stop selling Your personal
                                    information. To exercise Your right to
                                    opt-out, please contact Us. The Service
                                    Providers we partner with (for example, our
                                    analytics or advertising partners) may use
                                    technology on the Service that sells
                                    personal information as defined by the CCPA
                                    law. If you wish to opt out of the use of
                                    Your personal information for interest-based
                                    advertising purposes and these potential
                                    sales as defined under CCPA law, you may do
                                    so by following the instructions below.
                                    Please note that any opt out is specific to
                                    the browser You use. You may need to opt out
                                    on every browser that You use.
                                </p>
                                <h3 className="sub-title sub mb-40 mt-40">
                                    WEBSITE
                                </h3>
                                <p>
                                    You can opt out of receiving ads that are
                                    personalized as served by our Service
                                    Providers by following our instructions
                                ...
                                <p>
                                    ...
                                    computer that is unique to the browser You
                                    use to opt out. If you change browsers or
                                    delete the cookies saved by your browser,
                                ...
                                <p>
                                    ...
                                    to opt out of the use of information about
                                    the apps You use in order to serve You ads
                                    that are targeted to Your interests:
                                </p>
                                <ul className="desc-list">
                                    <li>
                                        ”Opt out of Interest-Based Ads" or "Opt
                                        out of Ads Personalization" on Android
                                        devices
                                    </li>
                                ...
                                <p>
                                    ...
                                    information from Your mobile device by
                                ...
                                <p>
                                    ...
                                    track of Your browsing activities. If You
                                    are visiting such websites, You can set Your
                                    preferences in Your web browser to inform
                                    websites that You do not want to be tracked.
                                    You can enable or disable DNT by visiting
                                ...
                                <p>
                                    The Service may contain content appropriate
                                    for children under the age of 13. As a
                                    parent, you should know that through the
                                    Service children under the age of 13 may
                                    participate in activities that involve the
                                    collection or use of personal information.
                                    We use reasonable efforts to ensure that
                                    before we collect any personal information
                                    from a child, the child's parent receives
                                    notice of and consents to our personal
                                    information practices.
                                </p>
                                <p>
                                    {" "}
                                    We also may limit how We collect, use, and
                                    store some of the information of Users
                                    between 13 and 18 years old. In some cases,
                                    this means We will be unable to provide
                                    certain functionality of the Service to
                                    these Users. If We need to rely on consent
                                    as a legal basis for processing Your
                                    information and Your country requires
                                    consent from a parent, We may require Your
                                    parent's consent before We collect and use
                                    that information.
                                </p>
                                <p>
                                    We may ask a User to verify its date of
                                    birth before collecting any personal
                                    information from them. If the User is under
                                    the age of 13, the Service will be either
                                    blocked or redirected to a parental consent
                                    process.
                                </p>
                                <h3 className="sub-title mb-40 mt-40">
                                ...
                                <p>
                                    The Company may collect and store persistent
                                    identifiers such as cookies or IP addresses
                                    from Children without parental consent for
                                    the purpose of supporting the internal
                                    operation of the Service.
                                </p>
                                <p>
                                    We may collect and store other personal
                                    information about children if this
                                    information is submitted by a child with
                                    prior parent consent or by the parent or
                                    guardian of the child.{" "}
                                </p>
                                <p>
                                    The Company may collect and store the
                                    following types of personal information
                                    about a child when submitted by a child with
                                    prior parental consent or by the parent or
                                    guardian of the child:
                                </p>
                                <ul className="desc-list">
                                ...
                                <p>
                                    For further details on the information We
                                    might collect, You can refer to the "Types
                                    of Data Collected" section of this Privacy
                                    Policy. We follow our standard Privacy
                                    Policy for the disclosure of personal
                                ...
                                <p>
                                    A parent who has already given the Company
                                    permission to collect and use his child
                                    personal information can, at any time:
                                </p>
                                <ul className="desc-list">
                                    <li>
                                        Review, correct or delete the child's
                                ...
                                <p>
                                    To make such a request, You can write to Us
                                ...
                                <p>
                                    ...
                                    California residents with an established
                                    business relationship with us can request
                                    information once a year about sharing their
                                    Personal Data with third parties for the
