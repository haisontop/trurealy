...
const SocialCard = (props: SocialCardProps) => {
    ...
    return (
        <div
            className={`flex cursor-pointer flex-col gap-y-2 p-4 pb-5 bg-white rounded rounded-4 ${styles["social-card"]}`}
        ...
        >
            <img
                ...
                alt="social"
            />
            <div className="text text-primary fs-6 mt-2">View more on instgram</div>
        </div>
    );
};
...
export const SocialCarousel = () => {
    ...
    return (
        <div className={`${styles["container"]} social-feed`}>
            <div
                className={`position-absolute ${styles["header"]} text-white fs-5`}
            >
                SOCIAL FEED
            </div>
            <AliceCarousel
