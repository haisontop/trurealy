      ...
      <div className={`${styles["join-us-top-header"]}`}>
        <div className={`${styles["join-us-top-header-content"]} bg-primary`}>
          ...
          <div className="text-white fs-5 mt-2 mt-xxl-5">
            ...
            innovation and inclusivity for consumers and agents alike.
          </div>
        </div>
      </div>
          ...
          <div className="col-12 col-md-12 col-lg-9 col-xxl-8">
            ...
            >
              <div className="text-white fs-4 xxl:fs-2">
                In 2018, TRU Realty was the first brokerage in the United States
      ...
      <div className={`${styles["join-us-bottom-header"]}`}>
        ...
        >
          ...
          <div className="text-white fs-5 mt-5">
            ...
            Smarter Agents And Unparalleled Experiences.
          </div>
        </div>
      </div>
    </div>
