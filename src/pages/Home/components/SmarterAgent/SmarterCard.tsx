...
const Smartercard = ({
    ...
    return (
        <div className="col-xl-4 col-md-6">
            <div
                className={`position-relative overflow-hidden ${style["smarter-box-2"]}`}
            >
                <img src={img} alt="" className="img-fluid" width="100%" />
                <div
                    className={`position-absolute bottom-0 ${bgColor} px-4 pt-2 pb-3 text-white ${style["smarter-card-anim"]}`}
                >
                    ...
                    <div className="mt-5 pt-md-5">
                        <Link to={link.href} style={{ textDecoration: "none" }}>
                            <div className="text-white d-flex">
                                <p className="pointer fw-normal">{link.name}</p>
                                <AiOutlineArrowRight
                                    size="30px"
                                    className="ms-2 mb-2"
                                />
