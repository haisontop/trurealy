...
export const Banner = () => {
    return (
        <div
            className={`container-xl px-0 width-100 overflow-hidden ${styles["banner-full-height"]}`}
        >
            <div className="row no-gutters h-100">
                <div className="col-md-6 overflow-hidden px-0 h-100 position-relative banner-col-parents">
                    <Image
                        src="/assets/left-banner.png"
                        className="img-fluid w-100 h-100 obj-cover"
                    ></Image>
                    <BannerText
