...
interface AgentSignUpFourProps {
	onSubmit: (event: React.MouseEvent<HTMLButtonElement>) => void;
	onPrevious: (event: React.MouseEvent<HTMLButtonElement>) => void;
}

export default function AgentFour({ onSubmit, onPrevious }: AgentSignUpFourProps) {
	const now = 100;
	return (
		<div className="col-md-12 allAgentmain g-0">
			...
			<div className="mainagentbox">
				...
				<div className="agentSign">
					<p className="agentname">How many transaction have you closed in your center?</p>
				</div>
				<div className="agentSelect">
					<div className="agentYes">
						<input type="radio" value="Yes" />
				...
				<div className="row">
					<div className="col-lg-6 col-md-6">
						<div className="agentSign agentaddress">
							<p className="agentname">License Namber</p>
						</div>
				...
				<div className="row">
					<div className="col-12">
						<div className="agentSign agentaddress">
							<h3>MLS</h3>
							<p className="agentname">
								What MLS Association are you currently a member of or do you need to be
								a member of?
							</p>
						</div>
						<div className="firstName">
					...
					<div className="col-12">
						<div className="agentSign agentaddress">
							<h3>NRDS ID</h3>
							<p className="agentname">
								Your National REALTORE Database System ID or NRDS is a 9 digit namber
								that is givan by the National Association of REALTORS?
							</p>
						</div>
						<div className="firstName">
							<input type="text" className="" />
