...
function AgentMiddleCard({img, name, about, email, website} : props) {
  ...
  return (
    <div className={` me-5 mb-5 ${style["agent-middle-card"]}`}>
        ...
        </div>
        {
            ...
            <div className={`overflow-hidden top-0 bg-primary ${style["card-about"]}`}>
                   ...
                   <div className='col-4'>
                       ...
                       <div className='px-3 py-3'>
                          ...
                          <div className='d-flex mt-3'>
                              <Link to="/">
                                      <FaFacebookF size="30px" className='text-white p-1 border border-white rounded-circle' />
                              </Link>
                              <Link to="/">
                                      <FaInstagram size="30px" className='text-white p-1 border border-white rounded-circle mx-3' />
                              </Link>
                              <Link to="/">
                                      <FaLinkedinIn size="30px" className='text-white p-1 border border-white rounded-circle' />
                              </Link>
                          </div>
                       </div>
                   </div>
             ...
             <div className='mt-5 text-white px-5'>
                 <h1 className='text-center fw-normal text-white'>GET MORE INFO</h1>
                 ...
                 <div className='mt-4'>
                     <p>
                       By continuing, you agree to our Terms of Use & Privacy Policy and understand that you may be contacted by real estate professionals and lenders via manual/automated calls, texts, and pre-recorded voice messages regarding your inquiries. Please note that you do not have to consent to these Terms of Use & Privacy Policy in order to purchase a property, goods, or services.
                     </p>
                 </div>
             </div>
            </div>
